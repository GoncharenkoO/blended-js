...
//   return array.filter((el) => el.eyeColor === color);
// }

// console.log(getUsersWithEyeColor(users, "blue"));

// function getUsersWithProperty(array, property, value) {
// 	return array.filter((el) => el[property] === value);
// }

// console.log(getUsersWithProperty(users, "gender", 'male'));
...
// return array.reduce((acc, el) => acc + el.balance, 0)
// }
...
// function tweetTags(array) {
//   return array.flatMap((el) => el.tags).reduce((acc, tag) => ({ ...acc, [tag]: acc[tag] ? acc[tag] + 1 : 1}), {});
// }

// console.log(tweetTags(tweets));
...
// const user = new User({ userName: "Poly", age: 20, numbersOfPost: 5});
...
// const client = new Client('Poly', 'poly@gmail.com')
// console.log(client);
// console.log(client.getClientData);
// console.log(client.changeEmail = 'change@gmail.com');
...
// 		const indexNotes = this.items.findIndex((note) => note.text === noteText);
// 		if (indexNotes !== -1) {
// 			console.log(this.items[indexNotes]);
// 			this.items[indexNotes].priopity = newPriority;
// 		}
// 	}
// }

// const notes = new Notes();
// notes.addNote({ text: "Hello", priopity: Notes.Priopity.HIGHT });
// notes.addNote({ text: "World", priopity: Notes.Priopity.LOW });
// notes.removeNote("World");
// notes.updatePriority('Hello', Notes.Priopity.LOW);
// console.log(notes);
